...
st.markdown(
    f"""
    **Achieving Net Zero by 2050** is not only a carbon reduction target, but also a great opportunity to 
    ...
    timing of **Net Zero Co-Benefits' gains** across neighbourhoods in **Cardiff**, the capital of Wales. 
    
    By **integrating Welsh Government deprivation metrics**, 
...
- **[Data Quality](./Data_Quality)**: we show the completeness of data by co-benefit type (some co-benefits were excluded from the main analysis since their data was almost incomplete)
