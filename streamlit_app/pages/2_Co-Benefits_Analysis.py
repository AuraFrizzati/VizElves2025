...
with st.expander('How to read the time series chart'):
    st.markdown("""
    * The black line shows the **Net Total Benefit**, the final value obtained after subtracting the negative Hassle Costs from all the other positive Net Zero Co-Benefits
    * The **Hassle Cost**: the grey bars below the zero line represent the friction of shifting to green habits (because of increased journey times). These costs act as a weight, pulling the net total significantly below gross benefits
